...
from model.model_transformers import OrablModel
...
class Orabl:
    def __init__(self, model_path, max_length=128, dataset_name="nyt") -> None:
        self.model = OrablModel.from_pretrained(model_path)
...
if __name__ == "__main__":
    ...
    orabl = orabl(model_path, dataset_name="nyt")
    
    print(orabl.predict("In perhaps the most ambitious Mekong cruise attempt, Impulse Tourism, an operator based in Chiang Mai, Thailand, is organizing an expedition starting in November in Jinghong, a small city in the Yunnan province in China."))
    print(orabl.predict("Adisham Hall in Sri Lanka was constructed between 1927 and 1931 at St Benedicts Monastery , Adisham , Haputhale , Sri Lanka in the Tudor and Jacobean style of architecture"))
    print(orabl.predict([
