...
from dataprocess.data_processor import OrablDataProcessor
from dataprocess.dataset import OrablDataset, OrablSpanDataset
...
DataProcessorDict = {
    "nyt_all_sa": OrablDataProcessor,
    "Orabl_span": OrablDataProcessor
}

DatasetDict = {
    "nyt_all_sa": OrablDataset,
    "Orabl_span": OrablSpanDataset
}

ModelDict = {
    "nyt_all_sa": OrablModel,
    "Orabl_span": OrablModel
}
...
DataMetricDict = {
    "nyt_all_sa": Orabl_metric,
    "Orabl_span": Orabl_span_metric
}
...
DataExtractDict = {
    "nyt_all_sa": Orabl_extractor,
    "Orabl_span": Orabl_span_extractor

}

LableNamesDict = {
    "nyt_all_sa": [ "tail_label"],
    "Orabl_span":["head_label", "tail_label", "span_label"],
}
